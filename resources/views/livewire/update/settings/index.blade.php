  ...
  <div class="card" x-data="{ activeTab: 'profil' }">
    ...
    <div x-show="activeTab === 'profil'" class="p-6 md:p-8">
      ...
      <form wire:submit.prevent="updateProfile" class="space-y-6">
        ...
        <div>
          ...
          <input type="text" id="nama" name="nama" value="Nama User" class="form-input">
        </div>
        <div>
    ...
    <div x-show="activeTab === 'keamanan'" x-cloak class="p-6 md:p-8">
      ...
      <form wire:submit.prevent="updatePassword" class="space-y-6 max-w-lg">
        ...
        <div>
          <label for="new_password" class="block text-sm font-medium text-slate-300 mb-2">Kata Sandi Baru</label>
  ...
  <div class="card mt-8 border-red-500/30">
    <div class="p-6 md:p-8">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <button @click="isDeleteAccountModalOpen = true" class="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded-lg transition-colors w-full md:w-auto cursor-pointer">Hapus Akun Saya</button>
      </div>
    </div>
  </div>

  <!-- ===== Delete Account Confirmation Modal ===== -->
  <div x-show="isDeleteAccountModalOpen" @keydown.escape.window="isDeleteAccountModalOpen = false" class="fixed inset-0 bg-black z-50 flex items-center justify-center p-4" style="background-color: rgba(0, 0, 0, 0.7);" x-cloak>
    <div @click.away="isDeleteAccountModalOpen = false" class="card w-full max-w-lg" x-data="{ confirmationText: '' }">
      <div class="p-6 md:p-8">
        ...
        <div class="mt-6 space-y-4">
          ...
          <button type="button" @click="isDeleteAccountModalOpen = false" class="w-full text-center py-2 text-slate-400 hover:text-white text-sm cursor-pointer">
            Batal
          </button>
        </div>
      </div>
